...
{ 
      ...
      $sql = "SELECT * FROM drinkmarket.Admin where Email=? and Password=?";
...
<form action="signin_admin.php" method="post">
 <div style="padding-left:20%; padding-right:30%;">
    <h4><b><i class="fa fa-lock"></i> SIGN IN - ADMIN</b></h4>
    ...
    <br/>
    <br/>
    SignIn as  <a href="signin.php" style="text-decoration:none;"><b>User</b></a> 
</div>  
</form>
